...
$(document).ready(function () {
    $("button.proceed").click(function (event) {
        ...
        let topping_value = ptopping.length * 20;
        ...
        $("button.deliver").click(function () {
            ...
            $("button.deliver").hide();
            $("#pizzatotal").hide();
            let deliveryAmount = checkoutTotal + 50;
        ...
        $("button#final-order").click(function (event) {
            ...
            if ($("input#name").val() && $("input#phone").val() && $("input#location").val() != "") {
                ...
                $("#finallmessage").append("Dear " + person + ", we have recieved your order which should be delivered to you at " + location + ". Pay ₹" + deliveryAmount + " upon delivery.");
                $("#totalbill").hide();
